...
protected:
    ...
    CellSet m_rows[9];
    CellSet m_cols[9];
    unsigned int numLastCandidate = 0;
    unsigned int numSingleCandidate = 0;
    unsigned int numCandidateLines = 0;
    unsigned int numMultipleLines = 0;
    unsigned int numNakedPair = 0;
    unsigned int numNakedTriple = 0;
    unsigned int numXWing = 0;
